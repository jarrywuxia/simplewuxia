              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {['Weapon', 'Armor', 'Relic', 'Boots'].map(slot => (
                      <div key={slot} className="aspect-square border border-dashed border-border flex flex-col items-center justify-center p-2 bg-stone-50/50">
                        <span className="text-[9px] text-ink-light uppercase opacity-50">{slot}</span>
                      </div>
                    ))}
                  </div>
                </div>
